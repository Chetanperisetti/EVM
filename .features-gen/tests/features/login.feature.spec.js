...
test.describe('Login and Dashboard', () => {
  ...
  test('Successful login should take user to dashboard', { tag: ['@login'] }, async ({ Given, When, Then, And, page }) => { 
    ...
    await And('I enter the email "user@example.com" in the username field', null, { page }); 
    await And('I enter the password "password123" in the password field', null, { page }); 
